...
class WC_Brands {
	...
	public function register_hooks() {
		...
		add_filter( 'woocommerce_rest_prepare_product', array( $this, 'rest_api_add_brands_to_product' ), 10, 2 ); // WC 2.6.x
		add_filter( 'woocommerce_rest_prepare_product_object', array( $this, 'rest_api_add_brands_to_product' ), 10, 2 ); // WC 3.x
	}
	 ...
	 */
	public function rest_api_add_brands_to_product( $response, $post ) {
